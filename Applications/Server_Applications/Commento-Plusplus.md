...
- `data-no-livereload="true"` - Disabled all hot reload functionality (this supersedes the above flag) - all comments are loaded once and only once on page load.
