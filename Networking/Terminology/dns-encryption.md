...
Both are based on Transport Layer Security ([[Transport_Layer_Security_tls]]) which is also used to secure communication between you and a website using HTTPS.
