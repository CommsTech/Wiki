...
var config = {
  ...
  site_title: 'COMMSNET Docs',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '',

  // Used for the "Get in touch" page footer link
  support_email: 'support@commsnet.org',
  ...
  secret: 'q2hzzmqGVGkqy23XutXGx6NK2BkPHmuTbQK7yoBWURJ7zHJWd7i2nxtTHvEb9UEb',

  credentials    : [
    {
      username : 'commstech',
      password : 'AfLYt7*q^6U8Fx$g'
    }
  ],
  ...
  home_meta : {
    // title       : 'Commsnet.org',
    // description : 'Commsnet Landing Page'
  },
