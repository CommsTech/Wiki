...
x) you need to centralize the collection of application logs like /var/log/httpd/access_log, and operating system logs like /var/log/messages for all of your EC2 Instances. How could you achieve this?
```
