...
```
	...
	D. Things you setup in cloudformations A
	Anwser: C
	Remarks:
	A. Outputs is how you spit things out of cloudformations 
	B. No Regions in cloudformation
...
16) A company has an infernal web application that runs on Amazon EC2 instances behind an Application Load Balancer. The instances run in an Amazon EC2 Auto  
...
17) A company hosts a website on multiple Amazon EC2 instances that run in an Auto Scaling group. Users are reporting slow responses during peak times between  
