...
A Cloud Access Security Broker (CASB) is a cloud computing tool used to discover internal use of cloud services using various mechanisms such as network monitoring.
